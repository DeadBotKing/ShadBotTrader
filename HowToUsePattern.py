...
patterns.percent_zigzag_finder = 1
patterns.profit = 10
...
print(zigzag_patterns['signal'].dropna())
print(zigzag_patterns['first_price'].dropna())

plt.plot(dataset_5M['close'], c = 'b')
plt.plot(zigzag_patterns['first_price'].dropna(), c = 'r')

for idx in zigzag_patterns['signal'][zigzag_patterns['signal'] == 'buy'].index:
	plt.axvline(x = idx, linestyle = '-.', c = 'orange')

for idx in zigzag_patterns['signal'][zigzag_patterns['signal'] == 'sell'].index:
	plt.axvline(x = idx, linestyle = '-.', c = 'purple')
