...
- Snapshot generated at: 2026-08-16T16:49:02.693634+00:00
...
Phase 28 - Implementation Foundation (persistence wired into every demo; dashboard shows real runs)
...
Model quality: the backtester still uses MomentumPredictionSource, a deliberate baseline. Feeding the trained WaveNet and the 109-feature catalogue into the simulation is the only remaining path to a strategy that could be profitable. Alternatively Phase 24 (deployment) to run the platform continuously.
