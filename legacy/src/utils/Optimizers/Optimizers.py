...
class Optimizers():
	...
	def FreqFinder(self, ts, detrend='linear'):
	    ...
	    if self.timeframe == '5M' or self.timeframe == '5T':
	    	min_time = '5T'

	    elif self.timeframe == '15M' or self.timeframe == '15T':
	    	min_time = '15T'
	    ...
	    # if round(freq) == 0: freq = 1

	    period_time = (freq * pd.Timedelta(min_time))/pd.Timedelta("1Y")

	    if period_time == 0: period_time = 1

	    return round(1/period_time), freqencies, spectrum
	...
	def MacdOptimizer(self):
		...
		if self.timeframe == '5M':
			...
			freq_time = str(15 * freq) + 'T'
		elif self.timeframe == '1H':
			freq_time = str(freq) + 'H'

		elif self.timeframe == '4H':
			freq_time = str(4 * freq) + 'H'

		elif self.timeframe == '1D':
			freq_time = str(freq) + 'D'
		...
		for i in range(self.turn):
			...
			macd_parameters.elements['MACD' + '_fast'] = randint(2, 36)#300)
			macd_parameters.elements['MACD' + '_slow'] = randint(2 , 78)#700)
			macd_parameters.elements['MACD' + '_signal'] = randint(2 , 27)
			...
			macd_parameters.elements['dataset_15M'] = self.dataset
			macd_parameters.elements['dataset_1H'] = self.dataset
			macd_parameters.elements['dataset_4H'] = self.dataset
			macd_parameters.elements['dataset_1D'] = self.dataset
	...
	def StochAsticOptimizer(self):
		...
		for i in range(self.turn):
			...
			stochastic_parameters.elements['StochAstic_k'] = randint(2, 15)#500)
			stochastic_parameters.elements['StochAstic_d'] = randint(2 , 9)#900)
			stochastic_parameters.elements['StochAstic_smooth_k'] = randint(2 , 9)
			...
			while stochastic_parameters.elements['StochAstic_d'] + 2 >= stochastic_parameters.elements['StochAstic_k']:
				stochastic_parameters.elements['StochAstic_k'] = randint(2, 15)#900)
				stochastic_parameters.elements['StochAstic_d'] = randint(2 , 9)#900)
			...
			if output.dropna().empty == False:
				...
				while (
					...
					while stochastic_parameters.elements['StochAstic_d'] + 2 >= stochastic_parameters.elements['StochAstic_k']:
						stochastic_parameters.elements['StochAstic_k'] = randint(2, 15)#700)
						stochastic_parameters.elements['StochAstic_d'] = randint(2 , 9)#700)
			...
			stochastic_parameters.elements['dataset_15M'] = self.dataset
			stochastic_parameters.elements['dataset_1H'] = self.dataset
			stochastic_parameters.elements['dataset_4H'] = self.dataset
			stochastic_parameters.elements['dataset_1D'] = self.dataset
	...
	def RSIOptimizer(self):
		...
		for i in range(self.turn):
			...
			rsi_parameters.elements['RSI' + '_length'] = randint(2, 42)
			...
			rsi_parameters.elements['dataset_15M'] = self.dataset
			rsi_parameters.elements['dataset_1H'] = self.dataset
			rsi_parameters.elements['dataset_4H'] = self.dataset
			rsi_parameters.elements['dataset_1D'] = self.dataset
