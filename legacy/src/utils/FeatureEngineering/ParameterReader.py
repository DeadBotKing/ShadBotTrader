	...
	def Divergence(
		...
		if indicator_name == 'macd':
			...
			if os.path.exists(
				...
				ind_parameters.elements['dataset_15M'] = dataset
				ind_parameters.elements['dataset_1H'] = dataset
				ind_parameters.elements['dataset_4H'] = dataset
				ind_parameters.elements['dataset_1D'] = dataset
				...
				macd_parameters.elements['dataset_15M'] = dataset
				macd_parameters.elements['dataset_1H'] = dataset
				macd_parameters.elements['dataset_4H'] = dataset
				macd_parameters.elements['dataset_1D'] = dataset
			...
			if os.path.exists(
				...
				stochastic_parameters.elements['dataset_15M'] = dataset
				stochastic_parameters.elements['dataset_1H'] = dataset
				stochastic_parameters.elements['dataset_4H'] = dataset
				stochastic_parameters.elements['dataset_1D'] = dataset
			...
			if os.path.exists(
				...
				rsi_parameters.elements['dataset_15M'] = dataset
				rsi_parameters.elements['dataset_1H'] = dataset
				rsi_parameters.elements['dataset_4H'] = dataset
				rsi_parameters.elements['dataset_1D'] = dataset
