...
dataset_1D = dataset_1D.drop(columns = ['XAUUSD_i', 'volume'])

print(dataset_1D)


frequences = Frequencies()
frequences = frequences.Get(dataset = dataset_1D, symbol = 'XAUUSD_i', mode = 'Run', number_frequencies = 2, name = '1D')

print('freqqqqq = ', frequences)
