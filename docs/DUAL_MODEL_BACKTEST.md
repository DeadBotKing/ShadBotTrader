...
`window_size` و `horizon` از training record خوانده می‌شوند. اگر کاربر پنجرهٔ دستی بدهد، override می‌شود؛ در غیر این صورت مقدار مدل ملاک است. آستانهٔ بک‌تست، آستانهٔ احتمال تصمیم است؛ label مدل binary است و neutral-band threshold ندارد.
