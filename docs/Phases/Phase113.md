...
اگر چندین مدل، feature subset، threshold، branch و ترکیب range-aware تست کنیم، بهترین نتیجه ممکن است صرفاً شانسی باشد. باید بررسی کنیم نتیجهٔ backtest واقعاً از random بهتر است یا نه.
