"""Phase131A: backtest a trained telemetry PatchTST meta-filter."""
...
DEFAULT_OUTPUT_DIR = Path("run_logs/hybrid_telemetry_patchtst_backtest")


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Backtest Phase131 telemetry PatchTST meta-filter.",
    ...
    parser.add_argument("--report-title", default="Telemetry PatchTST filtered hybrid replay")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        rule("PHASE131 TELEMETRY PATCHTST BACKTEST")
            ...
            json.dumps(
                {
                    ...
                    "patchtst_counters": asdict(counters),
                    "account": account,
