...
class CommandKind(str, Enum):
    ...
    BUILD_HYBRID_TELEMETRY_TENSOR = "build_hybrid_telemetry_tensor"
    INSPECT_HYBRID_TELEMETRY_TENSOR = "inspect_hybrid_telemetry_tensor"
    TRAIN_HYBRID_META_LABELER = "train_hybrid_meta_labeler"
    BACKTEST_HYBRID_META_LABELER = "backtest_hybrid_meta_labeler"
    TRAIN_HYBRID_TELEMETRY_WAVENET = "train_hybrid_telemetry_wavenet"
    BACKTEST_HYBRID_TELEMETRY_WAVENET = "backtest_hybrid_telemetry_wavenet"
    TRAIN_HYBRID_TELEMETRY_TSMIXER = "train_hybrid_telemetry_tsmixer"
    BACKTEST_HYBRID_TELEMETRY_TSMIXER = "backtest_hybrid_telemetry_tsmixer"
    TRAIN_HYBRID_TELEMETRY_PATCHTST = "train_hybrid_telemetry_patchtst"
    BACKTEST_HYBRID_TELEMETRY_PATCHTST = "backtest_hybrid_telemetry_patchtst"
    BACKTEST_META_FILTERED_HYBRID = "backtest_meta_filtered_hybrid"
    RUN_HYBRID_WALK_FORWARD_VALIDATION = "run_hybrid_walk_forward_validation"
    RUN_HYBRID_TENSOR_WALK_FORWARD_VALIDATION = "run_hybrid_tensor_walk_forward_validation"
    ANALYZE_TENSOR_FAILURE_REGIMES = "analyze_tensor_failure_regimes"
    BACKTEST_REGIME_FILTERED_HYBRID = "backtest_regime_filtered_hybrid"
    ANALYZE_TRADE_ANATOMY = "analyze_trade_anatomy"
    BACKTEST_BRACKET_RECALIBRATION = "backtest_bracket_recalibration"
    AUDIT_CANDIDATE_DIRECTION_ENTRY = "audit_candidate_direction_entry"
    TRAIN_PIVOT_PATTERN_RECOGNITION = "train_pivot_pattern_recognition"
    BUILD_PIVOT_PATTERN_TENSOR = "build_pivot_pattern_tensor"
